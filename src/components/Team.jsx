          ...
          <div className="flex flex-col md:flex-row items-center justify-between">
            <div data-aos="fade-right" className="mx-auto mt-[2rem] w-full md:w-1/2">
              <p className="w-full text-[1rem] tracking-[.5px] md:w-[500px] md:text-[1.1rem]">
                ...
                respectful culture, and we encourage our people to have the
                right mindsets and skills to navigate their present world and
                pursue careers as unique as they are, while building their
                unique experiences. We know that if team members are well
                supported and engaged in our mission and values, we can deliver
                better services. <br /><br /> We value team building and bonding. Unlike
                Jack, we work hard and play hard. We are not dull auditors. <br /><br /> We
                call ourselves 'The Team PAC.'
              </p>
            </div>
